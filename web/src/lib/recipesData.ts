...
export const RECIPES: Recipe[] = [
  ...
  {
    id: 'insect-june-beetle-roasted',
    animal: 'June Beetles',
    category: 'Insects',
    emoji: '🪲',
    title: 'Roasted June Beetles',
    intro:
      'June beetles/June bugs (Scarabaeidae). Large adult June beetles can be roasted and eaten where collection is legal.',
    ingredients: ['1–2 cups June beetles', '1 tbsp oil', 'Salt', 'Garlic powder', 'Smoked paprika', 'Black pepper'],
    instructions: [
      'Collect only from an area known to be free of pesticides.',
      'Keep the beetles cool.',
      'Rinse thoroughly.',
      'Blanch briefly in boiling water.',
      'Remove wings and hard legs.',
      'Pat dry.',
      'Toss with oil and seasonings.',
      'Roast around 350°F until crisp and thoroughly cooked.',
      'Season again immediately after roasting.',
    ],
    tip: 'Flavor: nutty and roasted.',
  },
  {
    id: 'insect-june-beetle-grub-crispy',
    animal: 'June Beetle Grubs',
    category: 'Insects',
    emoji: '🪲',
    title: 'Crispy Grubs',
    intro: 'The larvae of some scarab beetles are large enough to make a worthwhile food.',
    caution:
      "Do not assume every white grub is edible. Many unrelated beetle larvae look similar — positively identify the larvae, and don't collect grubs from chemically treated lawns, golf courses, gardens, or agricultural soil.",
    ingredients: ['Cleaned beetle grubs', 'Butter or oil', 'Salt', 'Pepper', 'Garlic', 'Lemon'],
    instructions: [
      'Positively identify the larvae.',
      'Do not collect grubs from chemically treated lawns, golf courses, gardens, or agricultural soil.',
      'Rinse thoroughly.',
      'Blanch before final cooking.',
  ...
  {
    id: 'insect-weevil-roasted',
    animal: 'Weevils',
    category: 'Insects',
    emoji: '🪲',
    title: 'Roasted Weevils',
    intro:
      "Weevils (superfamily Curculionoidea). There are enormous numbers of weevil species in America. Some larvae are substantial enough to eat, but \"weevil\" is not a single species, so identification matters.",
    ingredients: ['Legally collected weevils or larvae', 'Oil', 'Salt', 'Pepper', 'Garlic', 'Chili powder'],
    instructions: [
      'Identify the species/group.',
      'Collect only from an uncontaminated location.',
      'Rinse.',
      'Blanch.',
      'Dry.',
      'Toss with oil and seasonings.',
      'Roast until crisp and thoroughly cooked.',
    ],
  },
  {
    id: 'insect-longhorn-beetle-larva-wood-grub-fry',
    animal: 'Longhorn Beetle Larvae',
    category: 'Insects',
    emoji: '🪲',
    title: 'Wood-Grub Fry',
    intro:
      'Longhorn beetle larvae (family Cerambycidae) are often called wood grubs and can be surprisingly large.',
    caution: "Don't harvest larvae from treated lumber. Wood can contain preservatives, pesticides, or other chemicals.",
    ingredients: ['Properly identified edible beetle larvae', 'Butter', 'Garlic', 'Salt', 'Pepper'],
    instructions: [
      'Confirm the species.',
      'Collect only from clean, untreated wood.',
      'Remove debris.',
      'Rinse.',
      'Blanch.',
  ...
  {
    id: 'insect-stag-beetle-roasted',
    animal: 'Stag Beetles',
    category: 'Insects',
    emoji: '🪲',
    title: 'Roasted Stag Beetles',
    intro: 'Stag beetles (family Lucanidae) are visually distinctive and contain more material than tiny beetles.',
    caution: 'Some large beetles are locally uncommon. Don\'t collect rare or unusual specimens simply because they are large.',
    ingredients: ['Properly identified stag beetles', 'Oil', 'Salt', 'Pepper', 'Garlic', 'Chili powder'],
    instructions: [
      'Confirm identification.',
      'Collect only where permitted.',
      'Rinse.',
      'Blanch.',
      'Remove hard wings and legs.',
      'Roast or pan-fry.',
      'Cook completely.',
      'Season.',
    ],
  ...
  {
    id: 'insect-darkling-beetle-larva-mealworm-style',
    animal: 'Darkling Beetle Larvae',
    category: 'Insects',
    emoji: '🪲',
    title: 'Mealworm-Style Roasted Larvae',
    intro:
      'Darkling beetles (family Tenebrionidae) are an enormous beetle family. Some larvae are familiar as mealworms, which are already widely used as food.',
    caution: 'Food-grade farmed mealworms are very different from randomly collecting darkling beetles or larvae outdoors.',
    ingredients: ['Food-grade mealworms', 'Oil', 'Salt', 'Garlic', 'Paprika'],
    instructions: [
      'Prefer commercially raised food-grade mealworms.',
      'Rinse if appropriate for the product.',
      'Dry.',
  ...
  {
    id: 'insect-mealworm-garlic-paprika',
    animal: 'Mealworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Garlic-Paprika Mealworms',
    intro: 'Mealworms (Tenebrio molitor) are probably the most practical beetle larva for a wild-food cookbook.',
    ingredients: ['1 cup food-grade mealworms', '1 tbsp oil', 'Salt', 'Paprika', 'Garlic powder', 'Black pepper'],
    instructions: [
      'Use commercially raised food-grade mealworms.',
      "Prepare according to the producer's food-safety directions.",
      'Toss with oil and spices.',
      'Roast around 350°F until crisp and fully cooked.',
      'Cool slightly and eat as a snack.',
    ],
    tip: 'They can also be incorporated into trail mix, rice dishes, tacos, breads, or protein bars.',
  },
  {
    id: 'insect-superworm-roasted',
    animal: 'Superworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Roasted Superworms',
    intro: 'Superworms (Zophobas morio) are another commercially available beetle larva.',
    ingredients: ['Food-grade superworms', 'Oil', 'Salt', 'Chili powder', 'Lime'],
    instructions: [
      'Use commercially raised food-grade larvae.',
      'Prepare according to food-safety directions.',
      'Toss with oil and seasoning.',
      'Roast until crisp and completely cooked.',
      'Finish with lime.',
    ],
    tip: 'These are substantially larger than mealworms and work well as a crunchy snack.',
  },
  {
    id: 'insect-mealworm-roasted-simple',
    animal: 'Mealworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Roasted Mealworms',
    intro: 'Best source: commercially raised, food-grade mealworms.',
    ingredients: ['1 cup mealworms', '1 tbsp oil', 'Salt', 'Garlic powder', 'Paprika'],
    instructions: [
      'Use food-grade larvae.',
      "Prepare according to the producer's directions.",
      'Toss with oil and seasonings.',
      'Roast at about 350°F until crisp and thoroughly cooked.',
      'Serve as a snack.',
    ],
  },
  {
    id: 'insect-mealworm-chili-lime',
    animal: 'Mealworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Chili-Lime Mealworms',
    ingredients: ['Cooked mealworms', 'Chili powder', 'Lime juice', 'Salt', 'Garlic powder'],
    instructions: ['Toss cooked mealworms with chili powder, lime juice, salt, and garlic powder.', 'Roast until crisp.'],
    tip: 'Excellent as a crunchy topping for tacos, rice, or salads.',
  },
  {
    id: 'insect-mealworm-garlic-butter',
    animal: 'Mealworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Garlic-Butter Mealworms',
    ingredients: ['Cooked mealworms', 'Butter', 'Garlic', 'Parsley', 'Lemon'],
    instructions: [
      'Melt butter.',
      'Add minced garlic.',
      'Add cooked mealworms.',
      'Sauté until crisp.',
      'Add parsley and lemon.',
    ],
  },
  {
    id: 'insect-superworm-stir-fry',
    animal: 'Superworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Superworm Stir-Fry',
    intro: 'Common species: Zophobas morio.',
    ingredients: ['Food-grade superworms', 'Bell pepper', 'Onion', 'Garlic', 'Soy sauce', 'Oil'],
    instructions: [
      'Use food-grade larvae.',
      'Cook thoroughly.',
      'Stir-fry vegetables.',
      'Add the larvae.',
      'Add soy sauce.',
      'Continue cooking until everything is hot and thoroughly cooked.',
    ],
  },
  {
    id: 'insect-superworm-tacos',
    animal: 'Superworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Superworm Tacos',
    ingredients: ['Cooked food-grade superworms', 'Corn tortillas', 'Lettuce', 'Tomato', 'Onion', 'Lime', 'Salsa'],
    instructions: [
      'Roast or sauté the larvae until crisp.',
      'Warm tortillas.',
      'Add lettuce, tomato, onion, and larvae.',
      'Finish with lime and salsa.',
    ],
  },
  {
    id: 'insect-mealworm-trail-mix',
    animal: 'Mealworms',
    category: 'Insects',
    emoji: '🪲',
    title: 'Mealworm Trail Mix',
    instructions: [
      'Combine roasted mealworms with peanuts, pumpkin seeds, sunflower seeds, raisins, pretzels, and seasonings.',
    ],
    tip: 'This is one of the easiest ways to introduce edible larvae to someone who is hesitant about eating whole insects.',
  },
  {
    id: 'insect-caterpillar-cornmeal-fried',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Cornmeal-Fried Large Caterpillars',
    intro: 'For a confirmed edible caterpillar species, use a simple cornmeal coating.',
    caution: 'Do not use this recipe for an unidentified caterpillar.',
    ingredients: ['Properly identified edible caterpillars', 'Cornmeal', 'Flour', 'Salt', 'Pepper', 'Oil'],
    instructions: [
      'Positively identify the species.',
      'Remove any irritating hairs or spines only if the species-specific preparation calls for it.',
      'Rinse.',
      'Blanch.',
      'Coat with seasoned cornmeal.',
  ...
  {
    id: 'insect-caterpillar-roasted-moth-larva',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Roasted Edible Moth Caterpillars',
    intro: 'For a verified edible species.',
    caution: 'Do not use this recipe for an unidentified caterpillar or moth larva.',
    instructions: [
      'Clean the larvae.',
      'Blanch them.',
      'Dry thoroughly.',
    ...
    tip: 'Large larvae are substantially more practical than tiny caterpillars.',
  },
  {
    id: 'insect-caterpillar-garlic-herb',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Garlic-Herb Caterpillars',
    caution: 'Confirmed species only — do not use this recipe for an unidentified caterpillar.',
    ingredients: ['Confirmed edible caterpillars', 'Butter', 'Garlic', 'Thyme', 'Parsley', 'Lemon'],
    instructions: [
      'Properly identify the species.',
      'Process according to species-specific food guidance.',
      'Blanch.',
      'Sauté in butter and garlic.',
      'Cook thoroughly.',
      'Add herbs and lemon.',
  ...
  {
    id: 'insect-caterpillar-tacos',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Caterpillar Tacos',
    caution: 'Confirmed species only — do not use this recipe for an unidentified caterpillar.',
    ingredients: ['Thoroughly cooked confirmed edible caterpillars', 'Tortillas', 'Cabbage', 'Onion', 'Cilantro', 'Lime', 'Salsa'],
    instructions: [
      'Cook the caterpillars thoroughly.',
      'Serve in tortillas with cabbage, onion, cilantro, lime, and salsa.',
    ],
    tip: 'This is particularly suited to larger edible caterpillar species.',
  },
  {
    id: 'insect-caterpillar-fried-rice',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Caterpillar Fried Rice',
    caution: 'Confirmed species only — do not use this recipe for an unidentified caterpillar.',
    ingredients: ['Thoroughly cooked edible caterpillar meat', 'Cooked rice', 'Eggs', 'Peas', 'Carrots', 'Green onion', 'Soy sauce'],
    instructions: [
      'Scramble the eggs.',
      'Add vegetables.',
      'Add rice.',
      'Add thoroughly cooked caterpillars.',
      'Stir-fry until steaming hot.',
      'Add soy sauce.',
    ],
  },
  {
    id: 'insect-caterpillar-noodle-bowl',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Caterpillar Noodle Bowl',
    caution: 'Confirmed species only — do not use this recipe for an unidentified caterpillar.',
    ingredients: ['Thoroughly cooked edible larvae', 'Noodles', 'Broth', 'Mushrooms', 'Green onion', 'Garlic', 'Ginger'],
    instructions: ['Combine the thoroughly cooked larvae with noodles, broth, mushrooms, green onion, garlic, and ginger.', 'Simmer until everything is hot.'],
  },
  {
    id: 'insect-caterpillar-coconut-curry',
    animal: 'Caterpillars',
    category: 'Insects',
    emoji: '🐛',
    title: 'Coconut-Curried Caterpillars',
    caution: 'Confirmed species only — do not use this recipe for an unidentified caterpillar.',
    ingredients: ['Cooked edible caterpillars', 'Coconut milk', 'Curry powder', 'Onion', 'Garlic', 'Ginger', 'Vegetables'],
    instructions: [
  ...
  {
    id: 'insect-beetle-grub-crispy',
    animal: 'Beetle Grubs',
    category: 'Insects',
    emoji: '🪲',
    title: 'Crispy Beetle Grubs',
    intro: 'For positively identified edible beetle larvae.',
    caution: 'Never assume an unidentified white grub is edible.',
    instructions: [
      'Clean thoroughly.',
      'Blanch.',
      'Dry.',
  ...
  {
    id: 'insect-beetle-grub-garlic-butter',
    animal: 'Beetle Grubs',
    category: 'Insects',
    emoji: '🪲',
    title: 'Garlic-Butter Grubs',
    ingredients: ['Confirmed edible grubs', 'Butter', 'Garlic', 'Parsley', 'Lemon'],
    instructions: ['Sauté thoroughly cooked grubs in garlic butter.', 'Finish with lemon.'],
  },
  {
    id: 'insect-beetle-grub-fritters',
    animal: 'Beetle Grubs',
    category: 'Insects',
    emoji: '🪲',
    title: 'Grub Fritters',
    ingredients: ['Cooked edible grubs', 'Cornmeal', 'Flour', 'Egg', 'Onion', 'Salt', 'Pepper'],
    instructions: [
      'Chop cooked grubs.',
  ...
  {
    id: 'insect-beetle-grub-vegetable-stir-fry',
    animal: 'Beetle Grubs',
    category: 'Insects',
    emoji: '🪲',
    title: 'Grub & Vegetable Stir-Fry',
    ingredients: ['Thoroughly cooked edible beetle larvae', 'Onion', 'Peppers', 'Carrots', 'Cabbage', 'Garlic', 'Soy sauce'],
    instructions: ['Combine the thoroughly cooked larvae with the vegetables, garlic, and soy sauce.', 'Stir-fry until steaming hot.'],
  },
  {
    id: 'insect-beetle-grub-chili',
    animal: 'Beetle Grubs',
    category: 'Insects',
    emoji: '🪲',
    title: 'Grub Chili',
    ingredients: ['Cooked edible beetle larvae', 'Beans', 'Tomatoes', 'Onion', 'Chili powder', 'Garlic', 'Cumin'],
    instructions: ['Simmer the chili.', 'Add the cooked larvae near the end.'],
  },
  {
    id: 'insect-black-soldier-fly-larva-crispy',
    animal: 'Black Soldier Fly Larvae',
    category: 'Insects',
    emoji: '🪰',
    title: 'Crispy Black Soldier Fly Larvae',
    intro: 'Black soldier fly (Hermetia illucens) larvae are increasingly produced commercially as an insect-protein source.',
    caution: "Don't collect them from garbage, manure, compost, or carcasses. Use commercially produced food-grade larvae only.",
    ingredients: ['Food-grade larvae', 'Oil', 'Salt', 'Paprika', 'Garlic'],
    instructions: [
      'Use commercially produced food-grade larvae.',
      "Follow the producer's preparation instructions.",
      'Season with oil and spices.',
      'Roast until crisp and thoroughly cooked.',
    ],
  },
  {
    id: 'insect-black-soldier-fly-larva-tacos',
    animal: 'Black Soldier Fly Larvae',
    category: 'Insects',
    emoji: '🪰',
    title: 'Black Soldier Fly Larva Tacos',
    ingredients: ['Food-grade black soldier fly larvae', 'Tortillas', 'Cabbage', 'Onion', 'Cilantro', 'Lime', 'Salsa'],
    instructions: [
      'Roast food-grade larvae until crisp.',
      'Serve with tortillas, cabbage, onion, cilantro, lime, and salsa.',
    ],
  },
  {
    id: 'insect-black-soldier-fly-larva-protein-patties',
    animal: 'Black Soldier Fly Larvae',
    category: 'Insects',
    emoji: '🪰',
    title: 'Black Soldier Fly Larva Protein Patties',
    ingredients: ['Cooked food-grade larvae', 'Cooked beans', 'Oats', 'Onion', 'Garlic', 'Egg', 'Salt and pepper'],
    instructions: [
      'Chop the cooked larvae.',
      'Mix with beans, oats, onion, garlic, and egg.',
      'Form patties.',
  ...
  {
    id: 'insect-caddisfly-larva-fry',
    animal: 'Caddisfly Larvae',
    category: 'Insects',
    emoji: '🐛',
    title: 'Simple Caddisfly-Larva Fry',
    intro:
      'Caddisfly larvae are another interesting aquatic food possibility, but they live in streams and other freshwater environments, so water quality becomes critical. For a verified edible species from a clean, legally harvestable waterway:',
    instructions: [
      'Collect only where permitted.',
      'Rinse thoroughly.',
      'Blanch.',
    ...
    tip: "Reality check: they're extremely small, so you would need a large number to make a meal — for most Americans, they're much more valuable as indicators of stream health than as food.",
  },
  {
    id: 'insect-honeypot-ant-treat',
    animal: 'Honeypot Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Simple Honeypot Ant Treat',
    intro:
      'Honeypot ants (Myrmecocystus, also called honey ants) are among the most interesting ants from a food perspective because certain workers become repletes, storing liquid food in greatly enlarged abdomens.',
    ingredients: ['Legally collected honeypot ants'],
    instructions: [
      'Positively identify the colony.',
      'Collect only where permitted.',
      'Handle carefully without crushing the replete abdomen.',
      'Remove obvious dirt and debris.',
      'Chill briefly if desired.',
      'Eat the honey-filled abdomen whole, or separate it from the rest of the ant.',
    ],
    tip: 'Flavor: naturally sweet, sometimes described as honey-like. Excellent food candidate where traditionally and legally collected.',
  },
  {
    id: 'insect-honeypot-ant-dessert',
    animal: 'Honeypot Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Honey-Ant Dessert',
    intro: 'For a more unusual presentation.',
    ingredients: ['Honeypot ant repletes', 'Fresh berries', 'Plain yogurt', 'Small amount of honey'],
    instructions: [
      'Prepare the ants as above.',
      'Place berries and yogurt in a bowl.',
      'Add the repletes.',
      'Drizzle very lightly with honey.',
    ],
    tip: 'The ants provide a naturally sweet component without needing to cook them.',
  },
  {
    id: 'insect-carpenter-ant-toasted',
    animal: 'Carpenter Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Toasted Carpenter Ants',
    intro: "Carpenter ants (Camponotus) are among America's largest and most recognizable ants.",
    ingredients: ['Cleaned carpenter ants', 'Butter', 'Salt', 'Garlic powder'],
    instructions: [
      'Positively identify the ants.',
      'Collect from pesticide-free locations.',
      'Remove debris.',
      'Briefly blanch.',
      'Drain.',
      'Toast in a dry skillet or with a small amount of butter.',
      'Cook thoroughly.',
      'Season lightly.',
    ],
    tip: 'Carpenter ants can have a tangy, acidic flavor because of their formic acid.',
  },
  {
    id: 'insect-carpenter-ant-garlic-butter',
    animal: 'Carpenter Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Garlic-Butter Ants',
    ingredients: ['Prepared carpenter ants', 'Butter', 'Garlic', 'Parsley', 'Lemon'],
    instructions: [
      'Blanch the ants.',
      'Melt butter.',
      'Add garlic.',
      'Add ants.',
      'Toast until crisp.',
      'Add parsley and a small amount of lemon.',
    ],
    tip: 'The acidic character of carpenter ants can work surprisingly well with butter and lemon.',
  },
  {
    id: 'insect-field-ant-toasted',
    animal: 'Field Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Toasted Field Ants',
    intro:
      'Field ants (Formicinae and related ground-nesting ants) — many American fields contain large numbers of small-to-medium ants, but "field ant" is not one species.',
    caution: "Don't use this recipe for an unidentified ant colony.",
    ingredients: ['Positively identified edible field ants', 'Oil', 'Salt', 'Chili powder'],
    instructions: [
      'Confirm the species.',
      'Collect only from pesticide-free ground.',
  ...
  {
    id: 'insect-harvester-ant-protein-snack',
    animal: 'Harvester Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Ant Protein Snack',
    intro:
      'Harvester ants (Pogonomyrmex and related groups) are particularly interesting because some species are large enough to be practical food insects.',
    caution: "Use extreme caution during identification — some harvester ants can deliver painful stings. Don't confuse harvester ants with fire ants.",
    ingredients: ['Properly identified harvester ants', 'Salt', 'Chili powder', 'Oil'],
    instructions: [
      'Use extreme caution during identification.',
      'Collect only where legal.',
      'Remove dirt and plant material.',
      'Blanch.',
      'Dry.',
      'Toss with oil and spices.',
      'Roast until crisp.',
  ...
  {
    id: 'insect-leafcutter-ant-roasted',
    animal: 'Leafcutter Ants',
    category: 'Insects',
    emoji: '🐜',
    title: 'Roasted Leafcutter Ants',
    intro:
      'Leafcutter ants (Atta and Acromyrmex) are fascinating social insects, but their American distribution is largely southern and tropical/subtropical. Where a legally harvestable species is documented as food, larger workers can be prepared this way.',
    caution: 'Only include where the exact species and collection rules have been verified.',
    ingredients: ['Legally harvested leafcutter ant workers', 'Salt', 'Chili powder'],
    instructions: ['Clean the ants.', 'Blanch.', 'Drain.', 'Toast or roast.', 'Season with salt and chili.', 'Eat whole.'],
  },
  {
    id: 'insect-ant-brood-crispy',
    animal: 'Ant Brood',
    category: 'Insects',
    emoji: '🥚',
    title: 'Crispy Ant Brood',
    intro:
      'Ant brood consists primarily of larvae and pupae, which are relatively soft and protein-rich — arguably more useful than eating adult ants.',
    ingredients: ['Legally obtained ant larvae/pupae', 'Butter or oil', 'Salt', 'Garlic', 'Black pepper'],
    instructions: [
      'Obtain brood from a confirmed edible species.',
      'Remove soil and debris.',
      'Rinse gently.',
      'Blanch briefly.',
      'Drain carefully.',
      'Sauté in butter or oil.',
      'Cook thoroughly until hot and lightly crisp.',
      'Season with salt, pepper, and garlic.',
    ],
    tip: 'Texture: much softer than adult ants.',
  },
  {
    id: 'insect-ant-brood-fried-rice',
    animal: 'Ant Brood',
    category: 'Insects',
    emoji: '🥚',
    title: 'Ant Brood Fried Rice',
    ingredients: ['Cooked ant brood', 'Cooked rice', 'Egg', 'Green onion', 'Carrot', 'Peas', 'Soy sauce'],
    instructions: [
      'Scramble the egg.',
      'Add vegetables.',
      'Add rice.',
      'Add thoroughly cooked ant brood.',
      'Stir-fry until steaming hot.',
      'Add soy sauce.',
    ],
  },
  {
    id: 'insect-honey-bee-simple-honey',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Simple Honey',
    intro: 'The most practical honey-bee (Apis mellifera) food is, of course, honey.',
    caution: 'Prefer honey from managed, food-producing colonies rather than raiding wild colonies.',
    ingredients: ['Honey'],
    instructions: [
      'Enjoy honey on bread.',
  ...
  {
    id: 'insect-honey-bee-fresh-honeycomb',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Fresh Honeycomb',
    ingredients: ['Food-grade honeycomb', 'Bread or crackers', 'Cheese', 'Fruit'],
    instructions: [
      'Cut a small piece of honeycomb.',
      'Serve at room temperature.',
      'Eat the honey and wax together, or chew the wax and discard it afterward.',
    ],
    tip: "The wax itself isn't particularly digestible, but small amounts are commonly consumed with honeycomb.",
  },
  {
    id: 'insect-honey-bee-honey-glazed-nuts',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Honey-Glazed Nuts',
    ingredients: ['Mixed nuts', 'Honey', 'Salt', 'Cinnamon'],
    instructions: [
      'Mix nuts with honey.',
      'Spread on a baking sheet.',
      'Bake until toasted.',
      'Sprinkle lightly with salt and cinnamon.',
      'Cool before serving.',
    ],
    tip: 'This is a good recipe because it uses a bee product without requiring people to handle bees.',
  },
  {
    id: 'insect-honey-bee-roasted-adult',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Roasted Adult Bees',
    intro:
      'Adult bees have historically been consumed in various culinary traditions, but this is an advanced food rather than a beginner wild-food recipe.',
    caution:
      "Do not collect bees from flowers that may have been recently treated with pesticides, and don't kill wild pollinators simply to obtain a snack.",
    instructions: [
      'Obtain bees from a safe, known source.',
      'Remove debris.',
      'Cook thoroughly by roasting or frying.',
      'Remove particularly hard portions if desired.',
      'Season with salt and spices.',
    ],
  },
  {
    id: 'insect-honey-bee-crispy-brood',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Crispy Bee Brood',
    intro: 'Bee larvae and pupae are more substantial than adult bees.',
    caution: "Present this as a traditional/advanced food rather than something obtained by destroying wild colonies.",
    ingredients: ['Food-grade bee brood', 'Oil', 'Salt', 'Garlic powder'],
    instructions: [
      'Obtain brood from a known, food-safe source.',
      'Separate larvae/pupae from wax and debris.',
      'Cook thoroughly.',
      'Pan-fry or roast until lightly crisp.',
      'Season with salt and garlic.',
    ],
  },
  {
    id: 'insect-honey-bee-brood-garlic-butter',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Honey Bee Brood — Garlic Butter',
    ingredients: ['Properly obtained bee brood', 'Butter', 'Garlic', 'Parsley', 'Lemon'],
    instructions: [
      'Clean the brood carefully.',
      'Cook thoroughly.',
      'Melt butter.',
      'Add garlic.',
      'Add brood.',
      'Cook until hot and lightly browned.',
      'Finish with parsley and lemon.',
    ],
  },
  {
    id: 'insect-honey-bee-brood-flatbread',
    animal: 'Honey Bee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Honey & Bee-Brood Flatbread',
    intro: 'This would make an unusual showcase recipe for the book.',
    ingredients: ['Flatbread', 'Honey', 'Food-grade bee brood', 'Soft cheese', 'Walnuts', 'Fresh herbs'],
    instructions: [
      'Bake or toast the flatbread.',
      'Add cheese.',
      'Add thoroughly cooked bee brood.',
      'Add walnuts.',
      'Warm until the cheese softens.',
      'Drizzle lightly with honey.',
      'Add fresh herbs.',
    ],
    tip: 'The combination of sweet honey, salty/crispy brood, and cheese gives a distinctive recipe rather than another fried-insect snack.',
  },
  {
    id: 'insect-bumblebee-roasted',
    animal: 'Bumblebee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Roasted Bumblebees',
    intro: 'Bumblebees are considerably less practical as food than honey bees, and they are important pollinators.',
    caution: 'Not recommended as a routine wild harvest — only for a confirmed, legally obtainable food source.',
    instructions: ['Remove debris.', 'Cook thoroughly.', 'Roast until crisp.', 'Season with salt and spices.'],
  },
  {
    id: 'insect-bumblebee-brood-pan-fried',
    animal: 'Bumblebee',
    category: 'Insects',
    emoji: '🐝',
    title: 'Pan-Fried Bumblebee Brood',
    intro: 'Bumblebee larvae and pupae are more substantial than adults.',
    caution:
      'Bumblebee populations face numerous environmental pressures — leave wild colonies alone unless there is a legitimate, legal food-harvest context.',
    ingredients: ['Properly obtained brood', 'Butter', 'Salt', 'Pepper'],
    instructions: ['Separate brood from nest material.', 'Clean carefully.', 'Cook thoroughly.', 'Pan-fry in butter.', 'Season.'],
  },
  {
    id: 'insect-paper-wasp-crispy',
    animal: 'Paper Wasps',
    category: 'Insects',
    emoji: '🐝',
    title: 'Crispy Wasps',
    intro:
      'Paper wasps (family Vespidae, Polistes) — adult paper wasps are technically edible, but harvesting them carries a substantial sting risk.',
    caution: "Don't tell inexperienced readers to dismantle an active paper-wasp nest — that's an unnecessary way to get stung.",
    instructions: ['Remove debris.', 'Cook thoroughly.', 'Roast or fry until crisp.', 'Season with salt, chili, and lime.'],
  },
  {
    id: 'insect-paper-wasp-brood',
    animal: 'Paper Wasps',
    category: 'Insects',
    emoji: '🐝',
    title: 'Wasp Brood',
    intro: 'Paper wasp larvae and pupae are one of the more interesting food possibilities.',
    ingredients: ['Properly obtained wasp brood', 'Oil', 'Garlic', 'Chili powder', 'Lime'],
    instructions: [
      'Separate larvae/pupae from nest material.',
      'Clean carefully.',
      'Cook thoroughly.',
      'Sauté or roast.',
    ...
    tip: 'Wasp brood is substantially more useful as food than the tiny adult insects.',
  },
  {
    id: 'insect-yellowjacket-brood-crispy',
    animal: 'Yellowjacket',
    category: 'Insects',
    emoji: '🐝',
    title: 'Crispy Wasp Brood',
    intro:
      'Yellowjacket brood (Vespula, Dolichovespula and related groups) can be a substantial food source, but the nest is the dangerous part.',
    caution: 'Do not recommend digging into or opening a live underground yellowjacket nest as a beginner activity.',
    instructions: [
      'Separate larvae/pupae from nest material.',
      'Clean.',
      'Cook thoroughly.',
  ...
  {
    id: 'insect-yellowjacket-brood-tacos',
    animal: 'Yellowjacket',
    category: 'Insects',
    emoji: '🐝',
    title: 'Yellowjacket Brood Tacos',
    ingredients: ['Cooked yellowjacket brood', 'Corn tortillas', 'Cabbage', 'Onion', 'Cilantro', 'Lime', 'Salsa'],
    instructions: [
      'Crisp the cooked brood in a skillet.',
      'Warm tortillas.',
      'Add cabbage and onion.',
      'Add brood.',
      'Finish with cilantro, lime, and salsa.',
    ],
  },
  {
    id: 'insect-wasp-brood-fried-rice',
    animal: 'Wasp Brood',
    category: 'Insects',
    emoji: '🐝',
    title: 'Wasp Brood Fried Rice',
    ingredients: ['Thoroughly cooked wasp larvae/pupae', 'Rice', 'Egg', 'Peas', 'Carrots', 'Green onion', 'Soy sauce'],
    instructions: [
      'Scramble the egg.',
      'Add vegetables.',
      'Add rice.',
      'Add thoroughly cooked brood.',
      'Stir-fry until steaming hot.',
      'Add soy sauce.',
    ],
  },
  {
    id: 'insect-wasp-brood-curry',
    animal: 'Wasp Brood',
    category: 'Insects',
    emoji: '🐝',
    title: 'Wasp Brood Curry',
    ingredients: ['Cooked wasp brood', 'Coconut milk', 'Curry powder', 'Onion', 'Garlic', 'Ginger', 'Vegetables'],
    instructions: [
      'Sauté onion, garlic, and ginger.',
      'Add curry powder.',
      'Add coconut milk.',
  ...
  {
    id: 'insect-cicada-classic-roasted',
    animal: 'Cicadas',
    category: 'Insects',
    emoji: '🪲',
    title: 'Classic Roasted Cicadas',
    intro:
      "Cicadas are probably the most interesting wild insect in this category. One terminology correction: cicadas are not locusts. \"Locust\" properly refers to certain grasshoppers capable of forming swarms — cicadas belong to a completely different insect order.",
    ingredients: ['Freshly collected cicadas', 'Oil', 'Salt', 'Black pepper', 'Garlic powder', 'Paprika'],
    instructions: [
      'Collect only where legal and away from pesticide-treated vegetation.',
      'Remove wings and legs.',
      'Rinse thoroughly.',
      'Blanch briefly.',
      'Pat dry.',
    ...
    tip: 'Large newly emerged cicadas are generally more substantial than older, tougher adults.',
  },
  {
    id: 'insect-cicada-chili-lime',
    animal: 'Cicadas',
    category: 'Insects',
    emoji: '🪲',
    title: 'Chili-Lime Cicadas',
    ingredients: ['Prepared cicadas', 'Chili powder', 'Garlic powder', 'Salt', 'Lime'],
    instructions: [
      'Roast or sauté the prepared cicadas until crisp.',
      'Sprinkle with chili and garlic.',
      'Add salt.',
      'Finish with fresh lime juice.',
    ],
    tip: 'This makes a good snack-style recipe.',
  },
  {
    id: 'insect-cicada-garlic-butter',
    animal: 'Cicadas',
    category: 'Insects',
    emoji: '🪲',
    title: 'Garlic-Butter Cicadas',
    ingredients: ['Cooked cicadas', 'Butter', 'Garlic', 'Parsley', 'Lemon'],
    instructions: [
      'Melt butter in a skillet.',
      'Add garlic.',
      'Add thoroughly cooked cicadas.',
      'Sauté until crisp.',
      'Add parsley.',
      'Finish with lemon.',
    ],
  ...
  {
    id: 'insect-cicada-tacos',
    animal: 'Cicadas',
    category: 'Insects',
    emoji: '🪲',
    title: 'Cicada Tacos',
    ingredients: ['Cooked cicadas', 'Corn tortillas', 'Cabbage', 'Onion', 'Cilantro', 'Lime', 'Salsa'],
    instructions: [
      'Crisp the cooked cicadas in a skillet.',
      'Warm tortillas.',
      'Add cabbage and onion.',
      'Add cicadas.',
  ...
  {
    id: 'insect-cicada-fried-rice',
    animal: 'Cicadas',
    category: 'Insects',
    emoji: '🪲',
    title: 'Cicada Fried Rice',
    ingredients: ['Cooked cicadas', 'Cooked rice', 'Egg', 'Peas', 'Carrots', 'Green onion', 'Soy sauce'],
    instructions: [
      'Scramble the egg.',
      'Add vegetables.',
      'Add rice.',
  ...
  {
    id: 'insect-cicada-flour-protein-powder',
    animal: 'Cicadas',
    category: 'Insects',
    emoji: '🪲',
    title: 'Cicada Flour/Protein Powder',
    intro:
      'For a more modern preparation, thoroughly cook and dehydrate food-safe cicadas and grind them into a powder for use in bread, crackers, pancakes, protein bars, pasta, or savory sauces.',
    caution: "This should only be done with properly identified, safely sourced insects. Don't grind unidentified wild insects into flour.",
    instructions: [
      'Cook the cicadas thoroughly.',
      'Dehydrate them completely.',
      'Grind into a fine powder.',
      'Store in an airtight container.',
      'Incorporate into bread, crackers, pancakes, protein bars, pasta, or savory sauces.',
    ],
  },
  {
    id: 'insect-dragonfly-nymph-crispy',
    animal: 'Dragonfly Nymphs',
    category: 'Insects',
    emoji: '🐉',
    title: 'Crispy Dragonfly Nymphs',
    intro:
      "Dragonfly nymphs live underwater. They're technically edible in some culinary traditions, but not nearly as practical in the United States as cicadas or farmed insects. For a positively identified, legally harvestable species from clean water:",
    caution: "Water quality is critical. Don't collect aquatic insects from polluted or contaminated waterways.",
    instructions: ['Rinse thoroughly.', 'Blanch.', 'Drain and dry.', 'Fry or roast.', 'Cook completely.', 'Season with salt and chili.'],
  },
  {
    id: 'insect-dragonfly-nymph-tacos',
    animal: 'Dragonfly Nymphs',
    category: 'Insects',
    emoji: '🐉',
    title: 'Dragonfly Nymph Tacos',
    caution: 'Species/waterway-specific; not a recommended beginner wild food.',
    ingredients: ['Prepared dragonfly nymphs', 'Corn tortillas', 'Cabbage', 'Onion', 'Lime', 'Salsa'],
    instructions: [
      'Prepare the nymphs as a crunchy filling.',
      'Warm tortillas.',
      'Add cabbage and onion.',
      'Add the nymphs.',
      'Finish with lime and salsa.',
  ...
  {
    id: 'insect-damselfly-nymph-crispy',
    animal: 'Damselfly Nymphs',
    category: 'Insects',
    emoji: '🪽',
    title: 'Crispy Aquatic Insects',
    intro:
      'Damselfly nymphs are smaller and generally less worthwhile than larger dragonfly nymphs. For a verified edible species:',
    caution: 'Potentially edible, but low food value and difficult harvesting.',
    instructions: ['Rinse.', 'Blanch.', 'Dry.', 'Roast or fry.', 'Season with garlic and salt.'],
  },
  {
    id: 'insect-termite-roasted',
    animal: 'Termites',
    category: 'Insects',
    emoji: '🐜',
    title: 'Roasted Termites',
    intro:
      'Termites are much more interesting from a food perspective than many people realize, though wild North American termites are not something to collect casually, especially from structures. For legally obtained, food-safe termites:',
    ingredients: ['Termites', 'Oil', 'Salt', 'Chili powder'],
    instructions: ['Remove debris.', 'Rinse if appropriate.', 'Cook thoroughly.', 'Roast or pan-fry until crisp.', 'Season.'],
  },
  {
    id: 'insect-termite-fried-rice',
    animal: 'Termites',
    category: 'Insects',
    emoji: '🐜',
    title: 'Termite Fried Rice',
    caution:
      'Never collect termites from houses, treated lumber, buildings, or structures. Structural termite treatments can involve chemicals that make the insects unsuitable for consumption.',
    ingredients: ['Cooked termites', 'Rice', 'Egg', 'Vegetables', 'Soy sauce'],
    instructions: ['Scramble egg.', 'Add vegetables.', 'Add rice.', 'Add thoroughly cooked termites.', 'Stir-fry until steaming.', 'Season with soy sauce.'],
  },
  {
    id: 'insect-termite-patties',
    animal: 'Termites',
    category: 'Insects',
    emoji: '🐜',
    title: 'Termite Patties',
    ingredients: ['Cooked termites', 'Cooked beans', 'Oats', 'Egg', 'Onion', 'Garlic', 'Salt'],
    instructions: ['Combine ingredients.', 'Form small patties.', 'Pan-fry thoroughly.', 'Serve with vegetables or sauce.'],
  },
  {
    id: 'insect-water-boatmen-roasted',
    animal: 'Water Boatmen',
    category: 'Insects',
    emoji: '🪳',
    title: 'Roasted Water Boatmen',
    intro: 'Water boatmen (family Corixidae) have a long history as human food in parts of the world.',
    caution: 'Potentially useful, but water quality and species identification are essential.',
    ingredients: ['Properly identified water boatmen', 'Oil', 'Salt', 'Chili powder'],
    instructions: ['Collect only from clean, legal waterways.', 'Rinse thoroughly.', 'Blanch.', 'Dry.', 'Roast until crisp.', 'Season.'],
  },
  {
    id: 'insect-giant-water-bug-roasted',
    animal: 'Giant Water Bugs',
    category: 'Insects',
    emoji: '🪳',
    title: 'Roasted Giant Water Bugs',
    intro:
      'Giant water bugs (family Belostomatidae, also called toe-biters) are large enough to be a substantial insect food. For a confirmed, legally sourced specimen:',
    caution:
      "They can deliver a very painful bite, even though they're not venomous in the way a snake is. Don't handle them carelessly.",
    instructions: [
      'Handle carefully.',
      'Remove wings and hard portions as appropriate.',
      'Blanch.',
      'Roast or fry thoroughly.',
      'Season with salt and chili.',
    ],
  },
  {
    id: 'insect-giant-water-bug-curry',
    animal: 'Giant Water Bugs',
    category: 'Insects',
    emoji: '🪳',
    title: 'Giant Water Bug Curry',
    intro: 'For prepared, thoroughly cooked giant water bugs.',
    ingredients: ['Cooked giant water bugs', 'Coconut milk', 'Curry powder', 'Garlic', 'Ginger', 'Onion', 'Vegetables'],
    instructions: [
      'Sauté onion, garlic, and ginger.',
      'Add curry spices.',
      'Add coconut milk.',
      'Add vegetables.',
      'Add thoroughly cooked insects.',
      'Simmer until hot.',
      'Serve over rice.',
    ],
  },
  {
    id: 'insect-treehopper-leafhopper-toasted',
    animal: 'Treehoppers & Leafhoppers',
    category: 'Insects',
    emoji: '🦗',
    title: 'Toasted Treehoppers & Leafhoppers',
    intro:
      "These are small plant-feeding insects. Some are eaten in various regions, but they're generally too small to make good wild-food targets in America. For a confirmed edible species:",
    caution: 'Potentially edible but generally impractical.',
    instructions: ['Collect from pesticide-free plants.', 'Rinse.', 'Blanch.', 'Toast with salt.', 'Add to rice or vegetables.'],
  },
  {
    id: 'insect-commercial-mix-spicy-roasted',
    animal: 'Insect Mix',
    category: 'Insects',
    emoji: '🪲',
    title: 'Spicy Roasted Insect Mix',
    intro:
      'For a practical entry rather than another obscure wild insect: use a food-grade mixture containing insects such as mealworms, crickets, and black soldier fly larvae.',
    ingredients: ['1 cup food-grade insect mixture', '1 tbsp oil', 'Chili powder', 'Garlic powder', 'Paprika', 'Salt', 'Lime'],
    instructions: [
      'Use only commercially produced food-grade insects.',
      "Prepare according to the product's food-safety directions.",
      'Toss with oil and spices.',
      'Roast until crisp and thoroughly cooked.',
      'Finish with lime.',
    ],
    tip: 'Serve as a snack or sprinkle over soups, salads, or rice.',
  },
]
...
/** Shown once in the "Insects" category section, after the beetle recipes.
 * "Beetle" is an enormous taxonomic group, not one food species, so this
 * covers the species-by-species status of the beetle groups that didn't
 * get a full recipe above. */
export const BEETLE_GUIDE: AnimalGroupGuide = {
  title: 'Beetles — Species-by-Species Status',
  intro:
    'Unlike something obvious such as a deer, a "beetle" isn\'t a food species — it\'s an enormous taxonomic group. Two larvae can look almost identical while having completely different biology.',
  statusEntries: [
    {
      name: 'Japanese Beetles',
      status: '🟡 Potentially edible, but not recommended from pest-control collections',
      note: "Japanese beetles (Popillia japonica) are widespread invasive pests. If they've been collected from plants treated with insecticides, do not eat them — never assume that washing or cooking removes pesticide residues.",
    },
    {
      name: 'Dung Beetles',
      status: '🚫 Not recommended as wild food',
      note: 'Direct associations with animal feces and decomposing material create obvious sanitation concerns. Their ecological role is much more valuable than their food value.',
    },
    {
      name: 'Water Beetles',
      status: '⚠️ Identify to species and verify legality',
      note: "Aquatic beetles include numerous groups, particularly diving beetles. Some are eaten in other parts of the world, but American water beetles shouldn't be treated as one edible category. Never collect aquatic beetles from polluted or contaminated water.",
    },
    {
      name: 'Predaceous Diving Beetles',
      status: '🟡 Potentially edible, but not recommended for casual wild collection',
      note: 'Family Dytiscidae — large, powerful aquatic beetles. Technically edible in some culinary traditions, but wild North American specimens can be difficult to identify and may come from questionable water.',
    },
    {
      name: 'Water Scavenger Beetles',
      status: '🟡 Potentially edible in principle, but generally not worth collecting',
      note: 'Family Hydrophilidae. Their small size and aquatic contamination concerns make them poor wild-food targets.',
    },
    {
      name: 'Palm Weevil-Type Larvae',
      status: '⚠️ Regional — only after positive identification',
      note: "Large weevil larvae are among the more substantial edible beetle larvae known worldwide, but don't assume a large grub found in a palm or tree is an edible palm-weevil larva. If you have a verified edible species, it can be roasted, fried, or sautéed.",
    },
    {
      name: 'Buprestid Beetle Larvae',
      status: '🟡 Specialist only — not a general-purpose wild-food target',
      note: 'Family Buprestidae (metallic wood-boring beetles), sometimes called flatheaded borers. Some insect larvae are eaten around the world, but unidentified buprestid larvae are not recommended for American wild harvest.',
    },
    {
      name: 'Do Not Eat',
      status: '🚨 Beetles I Would NOT Put in the Food Section',
      examples: [
        'Dung beetles — leave alone; sanitation concerns and poor food value.',
        "Unknown water beetles — don't eat unidentified aquatic beetles.",
        "Brightly colored or chemically defended beetles — don't assume they're edible.",
        'Beetles collected from pesticide-treated areas — do not eat.',
        'Beetles collected from contaminated soil or water — do not eat.',
        "Unknown larvae — don't eat a grub simply because it looks like a mealworm.",
      ],
    },
  ],
  extraNotes: [
    {
      heading: '🪲 Why Beetle Identification Matters',
      text: 'Never identify an edible beetle by color alone. Identify the species or a reliably identifiable food group first.',
    },
  ],
}

/** Shown once in the "Insects" category section, after the moth/
 * caterpillar/grub/fly-larva/aquatic-larva recipes. Covers the caterpillar
 * identification rule plus every larva group in this batch that didn't get
 * a recipe (fly maggots, mosquito larvae, mayfly nymphs, and the
 * specifically dangerous/venomous caterpillars), all in one place instead
 * of scattered across the section. */
export const CATERPILLAR_GUIDE: AnimalGroupGuide = {
  title: 'Caterpillars, Grubs & Larvae — Safety & Species Status',
  intro:
    "Never eat an unidentified caterpillar. In particular, avoid brightly colored, hairy, fuzzy, or heavily spined caterpillars unless you have positively identified the species as an established edible species. Also avoid larvae collected from pesticide-treated crops, lawns, or gardens; roadside vegetation; industrial or contaminated areas; near unknown mushrooms or poisonous plants; dead animals or sewage; or water with contamination advisories. Do not assume cooking makes a toxic caterpillar safe. For general wild-food purposes, favor food-grade farmed larvae and a limited number of well-established edible wild species rather than experimenting with random caterpillars.",
  statusEntries: [
    {
      name: 'Caterpillars You Should NOT Eat',
      status: '☠️ Venomous/Urticating — DO NOT TOUCH OR EAT',
      examples: [
        'Buck moth caterpillars — some have venomous/urticating spines.',
        'Io moth caterpillars — their spines can cause painful reactions.',
        'Saddleback caterpillars — their spines can inject irritating venom.',
        'Puss caterpillars — these can cause severe pain and other symptoms.',
        'Hag moth / monkey slug caterpillars — some have irritating or stinging structures.',
        'Unknown hairy or spiny caterpillars — do not touch or eat them.',
      ],
      note: "The important rule: hairy, fuzzy, spiny, brightly colored, or unfamiliar caterpillar = DON'T EAT.",
    },
    {
      name: 'Butterfly Larvae',
      status: '🚫 Generally leave wild butterfly caterpillars alone',
      note: "Butterfly caterpillars aren't a major American wild-food resource, and identification can be difficult — some feed on plants containing defensive compounds. No generic \"butterfly caterpillar\" recipe is given; only a specifically documented, legally harvestable edible species should ever be considered.",
    },
    {
      name: 'Fly Maggots',
      status: '🚫 DO NOT COLLECT RANDOM WILD MAGGOTS FOR FOOD',
      note: 'Not every fly larva is equivalent to a food-grade black soldier fly larva. Wild maggots can be associated with rotting food, feces, dead animals, disease organisms, and contaminated organic matter.',
    },
    {
      name: 'Mosquito Larvae',
      status: '🚫 Not food',
      note: "Even though they're technically edible in some contexts, they are far too small and present unnecessary sanitation concerns.",
    },
    {
      name: 'Mayfly Nymphs',
      status: '🟡 Potentially edible in principle, but not recommended for casual wild harvesting',
      note: 'Mayfly nymphs are aquatic insects and an important part of freshwater ecosystems. Collecting random American aquatic larvae introduces identification problems, water-quality concerns, potential contaminant exposure, and very low meat yield.',
    },
  ],
}

/** Shown once in the "Insects" category section, after the ant recipes.
 * Fire ants and pavement ants intentionally get no recipe — status entries
 * only. */
export const ANT_GUIDE: AnimalGroupGuide = {
  title: 'Ants — Species-by-Species Status',
  statusEntries: [
    {
      name: 'Fire Ants',
      status: '🚨 NOT RECOMMENDED AS A WILD FOOD',
      note: 'Fire ants (Solenopsis) are capable of painful stings and can cause serious allergic reactions. Although ants in the broad sense are edible, there is little reason to encourage readers to harvest fire ants — never disturb a fire-ant mound just to collect insects.',
    },
    {
      name: 'Pavement Ants',
      status: '🟡 Too small for practical harvest',
      note: "Pavement ants (Tetramorium) are widespread around homes and urban areas — technically an insect-food possibility, but not worth wild collection. The bigger problem is where they're found: ants collected around sidewalks, buildings, trash, pesticides, or roadways may be exposed to contaminants. Don't collect urban ants for food.",
    },
    {
      name: 'Ants I Would NOT Eat',
      status: '🚨 Don\'t experiment with these',
      examples: [
        'Fire ants — painful stings and potential allergic reactions.',
        'Unidentified stinging ants — never put an unknown ant in your mouth.',
        'Ants from pesticide-treated areas — cooking does not reliably eliminate pesticide residues.',
        'Ants from garbage/sewage areas — avoid potential contamination.',
        'Urban pavement ants — tiny, poor food yield, and questionable collection environments.',
        "Unknown ant brood — don't assume white larvae from any colony are safe.",
      ],
    },
  ],
}

/** Shown once in the "Insects" category section, after the bee/wasp
 * recipes. Solitary bees/wasps and the "Don't Experiment" groups
 * intentionally get no recipe — status entries only. */
export const BEE_WASP_GUIDE: AnimalGroupGuide = {
  title: 'Bees & Wasps — Safety & Species Status',
  intro:
    'Never eat an unidentified bee or wasp, and never attempt to handle an active nest just to obtain food. Extra caution is warranted for anyone with a known allergy to bee/wasp stings or venom. Also avoid insects collected from pesticide-treated flowers, agricultural fields, roadside vegetation, or other contaminated areas.',
  statusEntries: [
    {
      name: 'Solitary Bees',
      status: '⚠️ Species-specific',
      note: "Many different native bee groups — important pollinators. Don't casually harvest an unidentified solitary bee.",
    },
    {
      name: 'Solitary Wasps',
      status: '⚠️ Species-specific',
      note: "Many different groups. Treat the same as solitary bees — species matters, and most aren't practical or advisable wild food.",
    },
    {
      name: 'Bees & Wasps I\'d Put in the "Don\'t Experiment" Category',
      status: "🚫 Don't experiment with these",
      examples: [
        "Unidentified wasps — don't put an unknown wasp in your mouth.",
        'Active yellowjacket nests — particularly dangerous to inexperienced collectors.',
        "Hornets — don't encourage readers to harvest active hornet nests.",
        "Unknown bee species — there are many native bees that are important pollinators and shouldn't be casually harvested.",
        "Pesticide-exposed bees — a dead bee found near a treated crop isn't automatically safe food.",
        "Dead insects found on the ground — you don't know what killed them or what they contacted.",
      ],
    },
  ],
}

/** Shown once in the "Insects" category section, after the cicada/
 * dragonfly/damselfly/termite/water-bug/treehopper/insect-mix recipes.
 * Aphids, stink bugs, and assassin bugs intentionally get no recipe —
 * status entries only. */
export const OTHER_INSECTS_GUIDE: AnimalGroupGuide = {
  title: 'Other Insects — Safety & Species Status',
  intro:
    'Identify the insect before eating it. Avoid insects collected from pesticide-treated plants, roadsides, industrial areas, sewage-contaminated locations, unknown agricultural fields, or dead animals/garbage. Never assume that cooking destroys a defensive toxin or pesticide residue.',
  statusEntries: [
    {
      name: 'Aphids',
      status: '🟡 Potentially edible, but not recommended as wild harvest',
      note: "Aphids are tiny, and many feed on plants that may contain defensive compounds or pesticide residues. This is included primarily as an identification/edibility entry rather than an encouragement to gather them. Don't scrape aphids off random garden plants and eat them — you don't know what pesticides or plant chemicals they've encountered.",
    },
    {
      name: 'Stink Bugs',
      status: '🚨 Species-specific — never eat an unidentified stink bug',
      note: 'Some stink bugs are eaten in various cultures, but American stink bugs can release strong defensive chemicals, making this a poor "grab any bug" food category. Only specifically documented edible species should be considered.',
    },
    {
      name: 'Assassin Bugs',
      status: '🚫 Leave alone — not recommended as food',
      note: "Assassin bugs are predators and can deliver painful bites. Don't confuse them with other true bugs that may be eaten.",
    },
    {
      name: 'Important "Do Not Eat" List',
      status: "🚨 Don't eat unidentified insects",
      examples: [
        'Unknown true bugs',
        'Unknown aquatic insects',
        'Unknown brightly colored insects',
        'Unknown insects with strong odors',
        'Unknown insects with stingers',
        'Unknown insects from contaminated environments',
      ],
      note: "Also: don't collect insects from treated buildings (particularly important for termites), don't collect aquatic insects from questionable water (dragonfly/damselfly nymphs and water bugs can be exposed to contaminants), and don't assume every cicada is automatically safe — identify it and make sure it hasn't been exposed to pesticides or other contaminants.",
    },
  ],
}
