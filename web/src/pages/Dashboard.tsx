...
const FEATURES: Feature[] = [
  { icon: '🔍', title: 'Search', description: 'Search every guide at once — by typing or by voice.', to: '/app/search' },
  ...
  { icon: '🕸️', title: 'Snares & Traps', description: 'How to build snares to catch small game.', to: '/app/snares' },
