...
/**
 * Standalone public page — deliberately NOT wrapped in <Shell>, since Shell
 * assumes a signed-in user (sign-out button, tier badge, etc.). Terms need
 * to be readable by anyone, signed in or not.
 */
