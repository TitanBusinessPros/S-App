...
- **Water & Terrain Map**: adjustable-radius water search via USGS's 3D Hydrography Program (3DHP), through a Cloud Function; the map background itself is OpenStreetMap raster tiles
